...
_base_ = [
    ...
    '../_base_/datasets/uda_gtaHR_to_cityscapesHR_512x512.py',
...
uda = dict(
    ...
    #modified
    DECON=True, #DECOn loss
    kernel_size=3,
    crop_size=32,
    
    AP=True, # Attaching Private
    
    RO=True, # Resizing Object
    resize_scale=0.5,
    
    SAM_Refinement=True, # SAM Refinement
    SAM_ratio=0.3,
    pseudo_thres=0.5,
...
evaluation = dict(interval=4000, metric='h_score', save_best='h_score') # modified
